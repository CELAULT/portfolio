...
<section id="a-propos-de-moi">
  ...
  <p style="line-height: 200%; " class="alinea">J'ai <?= $age ?> ans, je suis originaire de la Normandie et j'habite actuellement dans la Manche dans la commune du Petit-Celland.
      Passionné par le fonctionnement des jeux vidéo, je me forme sur des logiciels tel que Blender.
      Aussi passionné par le fonctionnement des programmes informatiques, j’ai appris les bases du Php et JavaScript que j’ai approfondi de manière autonome depuis plusieurs années.
      Je me suis entraîné à réaliser de petits programmes de plus en plus complexes en fonction de mes connaissances.
      J'ai par la suite poursuivi mes études en BTS Services Informatiques aux Organisations (SIO) option B Solutions Logicielles et Applications Métiers (SLAM).
  ...
  <article class="paragraph">
    <p style="line-height: 200%; " class="alinea">
      ...
      Qui consiste à mettre en plan et des maquettes des bâtiments 

      Suite à mon Bac Pro j'ai été faire un BTS SIO au lycée Notre Dame de la Providance à Avranches (50).
      Pour la suite j'ai décidé de ne plus poursuivre d'étude mais de travailler dans le domaine de l'informatique et/ou du jeu vidéo.
    </p>
